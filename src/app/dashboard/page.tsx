      ...
      {role === 'Worker' ? (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl p-6 border border-[#E2E8F0] shadow-[0_10px_28px_rgba(15,23,42,0.06),_0_2px_6px_rgba(2,132,199,0.04)] hover:shadow-[0_18px_38px_rgba(2,132,199,0.14)] transition-all duration-300 hover:-translate-y-1 space-y-4">
            ...
            <div className="bg-white rounded-3xl p-6 border border-[#E2E8F0] shadow-[0_10px_28px_rgba(15,23,42,0.06),_0_2px_6px_rgba(2,132,199,0.04)] hover:shadow-[0_18px_38px_rgba(2,132,199,0.14)] transition-all duration-300 hover:-translate-y-1 space-y-4">
              <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-3">
                ...
                <span className="text-xs font-mono font-bold text-[#0284C7] bg-[#E0F2FE] px-2.5 py-0.5 rounded-full border border-[#BAE6FD]">
                  Station #2 (140m)
                </span>
              </div>

              <div className="grid grid-cols-3 gap-3 text-xs">
                <div className="p-3 rounded-2xl bg-sky-50/70 border border-sky-100 shadow-[0_2px_8px_rgba(2,132,199,0.06)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(2,132,199,0.14)] space-y-1">
                ...
                <div className="p-3 rounded-2xl bg-sky-50/70 border border-sky-100 shadow-[0_2px_8px_rgba(2,132,199,0.06)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(2,132,199,0.14)] space-y-1">
                  ...
                  <span className="text-[9px] text-sky-600 font-bold block">✓ Fully Supplied</span>
                </div>

                <div className="p-3 rounded-2xl bg-sky-50/70 border border-sky-100 shadow-[0_2px_8px_rgba(2,132,199,0.06)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(2,132,199,0.14)] space-y-1">
                  <span className="text-[10px] text-[#64748B] font-semibold block">Comm Beacon</span>
                  <span className="text-lg font-black text-[#0284C7] font-mono block">Sub-GHz</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-[#E3EAF5] shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-3">
              ...
              <span className="text-xs font-mono px-2.5 py-1 rounded-full bg-[#E0F2FE] text-[#0284C7] font-bold border border-[#BAE6FD]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {workers.map((worker) => (
                <div key={worker.id} className="p-4 rounded-2xl bg-[#F8FAFC] border border-[#E3EAF5] flex flex-col justify-between space-y-3">
      ...
      {role !== 'Supervisor' && (
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-[#0284C7] font-mono bg-[#E0F2FE] px-2.5 py-0.5 rounded-full font-semibold">
              12 Active Sensors
            </span>
          </div>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-[#0F172A] tracking-tight">
                Safety <span className="text-[#0284C7]">Alerts</span>
              </h2>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-full bg-white border border-[#E3EAF5] hover:border-[#BAE6FD] hover:bg-[#F0F7FF] text-[#475569] hover:text-[#0284C7] shadow-2xs transition-colors cursor-pointer"
            ...
            <Link
              href="/alerts"
              className="hidden sm:inline-flex items-center gap-1 px-3.5 py-1.5 text-xs font-semibold rounded-full border border-[#0284C7] text-[#0284C7] bg-white hover:bg-[#E0F2FE]/50 shadow-2xs transition-colors ml-2"
            >
              <span>View All</span>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {!alert.acknowledged && (
                    <button
                      ...
                      className="px-2.5 py-1 text-[11px] font-semibold bg-white hover:bg-white/90 rounded-full border border-black/10 shadow-2xs text-[#0284C7] cursor-pointer"
                    >
                      Ack
                    </button>
                  )}
            ...
            {workers.slice(0, 4).map((worker) => (
              <Card key={worker.id} variant="interactive" padding="md">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-[#E0F2FE] text-[#0284C7] font-semibold border border-[#BAE6FD]">
                    {worker.id}
                  </span>
                </div>

                <div className="mt-4 pt-3 border-t border-[#E3EAF5] grid grid-cols-2 gap-2 text-xs">
                  <div>
                    <span className="text-[10px] text-[#64748B] uppercase tracking-wider block">H2S Level</span>
                    <span className={`font-mono font-bold ${worker.h2s > 10 ? 'text-[#EF4444]' : worker.h2s >= 5 ? 'text-[#F59E0B]' : 'text-[#0284C7]'}`}>
                ...
                <div className="mt-3">
                  <Link href={`/workers/${worker.id}`} className="block">
                    <button className="w-full py-1.5 text-xs font-semibold rounded-full border border-[#BAE6FD] text-[#0284C7] bg-white hover:bg-[#E0F2FE]/50 transition-colors cursor-pointer shadow-2xs">
                      View Details & Trends →
                    </button>
                  </Link>
                </div>
