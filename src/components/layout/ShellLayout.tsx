...
function ShellContent({ children }: { children: React.ReactNode }) {
  ...
  if (isLoadingAuth || !isLoggedIn) {
    return (
      <div className="min-h-screen bg-[#EEF3FA] flex flex-col items-center justify-center p-6 text-[#0F172A] select-none">
        <div className="relative mb-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#0284C7] to-[#0EA5E9] flex items-center justify-center shadow-lg shadow-sky-500/20 animate-pulse border border-white/40">
